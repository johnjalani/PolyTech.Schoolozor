...
namespace Schoolozor.Services.Authentication.Controllers
{
    ...
    public class RoleController : Controller
    {
        ...
        public RoleController(RoleManager<IdentityRole> roleMgr, UserManager<SchoolUser> userMgr)
        {
            roleManager = roleMgr;
            userManager = userMgr;
        }
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            List<SchoolUser> members = new List<SchoolUser>();
            List<SchoolUser> nonMember = new List<SchoolUser>();

            foreach (SchoolUser user in userManager.Users.ToArray())
            {
