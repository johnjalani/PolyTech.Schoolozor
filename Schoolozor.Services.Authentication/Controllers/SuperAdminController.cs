...
namespace Schoolozor.Services.Authentication.Controllers
{
    ...
    {
        private UserManager<SchoolUser> userManager;
        private IUserValidator<SchoolUser> userValidator;
        private IPasswordValidator<SchoolUser> passwordValidator;
        private IPasswordHasher<SchoolUser> passwordHasher;

        private SchoolUser testUser = new SchoolUser
        {
            UserName = "TestTestForPassword",
            Email = "testForPassword@test.test"
        };

        public SuperAdminController(UserManager<SchoolUser> userMgr,
            IUserValidator<SchoolUser> userValid, IPasswordValidator<SchoolUser> passValid,
            IPasswordHasher<SchoolUser> passHasher)
        {
            userManager = userMgr;
